...
func (code ResourceType) Type() reflect.Type {
	switch code {
	case ResourceTypeAccount:
		return reflect.TypeOf(Account{})
	case ResourceTypeActivityDefinition:
		return reflect.TypeOf(ActivityDefinition{})
	case ResourceTypeAdverseEvent:
		return reflect.TypeOf(AdverseEvent{})
	case ResourceTypeAllergyIntolerance:
		return reflect.TypeOf(AllergyIntolerance{})
	case ResourceTypeAppointment:
		return reflect.TypeOf(Appointment{})
	case ResourceTypeAppointmentResponse:
		return reflect.TypeOf(AppointmentResponse{})
	case ResourceTypeAuditEvent:
		return reflect.TypeOf(AuditEvent{})
	case ResourceTypeBasic:
		return reflect.TypeOf(Basic{})
	case ResourceTypeBinary:
		return reflect.TypeOf(Binary{})
	case ResourceTypeBiologicallyDerivedProduct:
		return reflect.TypeOf(BiologicallyDerivedProduct{})
	case ResourceTypeBodyStructure:
		return reflect.TypeOf(BodyStructure{})
	case ResourceTypeBundle:
		return reflect.TypeOf(Bundle{})
	case ResourceTypeCapabilityStatement:
		return reflect.TypeOf(CapabilityStatement{})
	case ResourceTypeCarePlan:
		return reflect.TypeOf(CarePlan{})
	case ResourceTypeCareTeam:
		return reflect.TypeOf(CareTeam{})
	case ResourceTypeCatalogEntry:
		return reflect.TypeOf(CatalogEntry{})
	case ResourceTypeChargeItem:
		return reflect.TypeOf(ChargeItem{})
	case ResourceTypeChargeItemDefinition:
		return reflect.TypeOf(ChargeItemDefinition{})
	case ResourceTypeClaim:
		return reflect.TypeOf(Claim{})
	case ResourceTypeClaimResponse:
		return reflect.TypeOf(ClaimResponse{})
	case ResourceTypeClinicalImpression:
		return reflect.TypeOf(ClinicalImpression{})
	case ResourceTypeCodeSystem:
		return reflect.TypeOf(CodeSystem{})
	case ResourceTypeCommunication:
		return reflect.TypeOf(Communication{})
	case ResourceTypeCommunicationRequest:
		return reflect.TypeOf(CommunicationRequest{})
	case ResourceTypeCompartmentDefinition:
		return reflect.TypeOf(CompartmentDefinition{})
	case ResourceTypeComposition:
		return reflect.TypeOf(Composition{})
	case ResourceTypeConceptMap:
		return reflect.TypeOf(ConceptMap{})
	case ResourceTypeCondition:
		return reflect.TypeOf(Condition{})
	case ResourceTypeConsent:
		return reflect.TypeOf(Consent{})
	case ResourceTypeContract:
		return reflect.TypeOf(Contract{})
	case ResourceTypeCoverage:
		return reflect.TypeOf(Coverage{})
	case ResourceTypeCoverageEligibilityRequest:
		return reflect.TypeOf(CoverageEligibilityRequest{})
	case ResourceTypeCoverageEligibilityResponse:
		return reflect.TypeOf(CoverageEligibilityResponse{})
	case ResourceTypeDetectedIssue:
		return reflect.TypeOf(DetectedIssue{})
	case ResourceTypeDevice:
		return reflect.TypeOf(Device{})
	case ResourceTypeDeviceDefinition:
		return reflect.TypeOf(DeviceDefinition{})
	case ResourceTypeDeviceMetric:
		return reflect.TypeOf(DeviceMetric{})
	case ResourceTypeDeviceRequest:
		return reflect.TypeOf(DeviceRequest{})
	case ResourceTypeDeviceUseStatement:
		return reflect.TypeOf(DeviceUseStatement{})
	case ResourceTypeDiagnosticReport:
		return reflect.TypeOf(DiagnosticReport{})
	case ResourceTypeDocumentManifest:
		return reflect.TypeOf(DocumentManifest{})
	case ResourceTypeDocumentReference:
		return reflect.TypeOf(DocumentReference{})
	case ResourceTypeDomainResource:
		return reflect.TypeOf(DomainResource{})
	case ResourceTypeEffectEvidenceSynthesis:
		return reflect.TypeOf(EffectEvidenceSynthesis{})
	case ResourceTypeEncounter:
		return reflect.TypeOf(Encounter{})
	case ResourceTypeEndpoint:
		return reflect.TypeOf(Endpoint{})
	case ResourceTypeEnrollmentRequest:
		return reflect.TypeOf(EnrollmentRequest{})
	case ResourceTypeEnrollmentResponse:
		return reflect.TypeOf(EnrollmentResponse{})
	case ResourceTypeEpisodeOfCare:
		return reflect.TypeOf(EpisodeOfCare{})
	case ResourceTypeEventDefinition:
		return reflect.TypeOf(EventDefinition{})
	case ResourceTypeEvidence:
		return reflect.TypeOf(Evidence{})
	case ResourceTypeEvidenceVariable:
		return reflect.TypeOf(EvidenceVariable{})
	case ResourceTypeExampleScenario:
		return reflect.TypeOf(ExampleScenario{})
	case ResourceTypeExplanationOfBenefit:
		return reflect.TypeOf(ExplanationOfBenefit{})
	case ResourceTypeFamilyMemberHistory:
		return reflect.TypeOf(FamilyMemberHistory{})
	case ResourceTypeFlag:
		return reflect.TypeOf(Flag{})
	case ResourceTypeGoal:
		return reflect.TypeOf(Goal{})
	case ResourceTypeGraphDefinition:
		return reflect.TypeOf(GraphDefinition{})
	case ResourceTypeGroup:
		return reflect.TypeOf(Group{})
	case ResourceTypeGuidanceResponse:
		return reflect.TypeOf(GuidanceResponse{})
	case ResourceTypeHealthcareService:
		return reflect.TypeOf(HealthcareService{})
	case ResourceTypeImagingStudy:
		return reflect.TypeOf(ImagingStudy{})
	case ResourceTypeImmunization:
		return reflect.TypeOf(Immunization{})
	case ResourceTypeImmunizationEvaluation:
		return reflect.TypeOf(ImmunizationEvaluation{})
	case ResourceTypeImmunizationRecommendation:
		return reflect.TypeOf(ImmunizationRecommendation{})
	case ResourceTypeImplementationGuide:
		return reflect.TypeOf(ImplementationGuide{})
	case ResourceTypeInsurancePlan:
		return reflect.TypeOf(InsurancePlan{})
	case ResourceTypeInvoice:
		return reflect.TypeOf(Invoice{})
	case ResourceTypeLibrary:
		return reflect.TypeOf(Library{})
	case ResourceTypeLinkage:
		return reflect.TypeOf(Linkage{})
	case ResourceTypeList:
		return reflect.TypeOf(List{})
	case ResourceTypeLocation:
		return reflect.TypeOf(Location{})
	case ResourceTypeMeasure:
		return reflect.TypeOf(Measure{})
	case ResourceTypeMeasureReport:
		return reflect.TypeOf(MeasureReport{})
	case ResourceTypeMedia:
		return reflect.TypeOf(Media{})
	case ResourceTypeMedication:
		return reflect.TypeOf(Medication{})
	case ResourceTypeMedicationAdministration:
		return reflect.TypeOf(MedicationAdministration{})
	case ResourceTypeMedicationDispense:
		return reflect.TypeOf(MedicationDispense{})
	case ResourceTypeMedicationKnowledge:
		return reflect.TypeOf(MedicationKnowledge{})
	case ResourceTypeMedicationRequest:
		return reflect.TypeOf(MedicationRequest{})
	case ResourceTypeMedicationStatement:
		return reflect.TypeOf(MedicationStatement{})
	case ResourceTypeMedicinalProduct:
		return reflect.TypeOf(MedicinalProduct{})
	case ResourceTypeMedicinalProductAuthorization:
		return reflect.TypeOf(MedicinalProductAuthorization{})
	case ResourceTypeMedicinalProductContraindication:
		return reflect.TypeOf(MedicinalProductContraindication{})
	case ResourceTypeMedicinalProductIndication:
		return reflect.TypeOf(MedicinalProductIndication{})
	case ResourceTypeMedicinalProductIngredient:
		return reflect.TypeOf(MedicinalProductIngredient{})
	case ResourceTypeMedicinalProductInteraction:
		return reflect.TypeOf(MedicinalProductInteraction{})
	case ResourceTypeMedicinalProductManufactured:
		return reflect.TypeOf(MedicinalProductManufactured{})
	case ResourceTypeMedicinalProductPackaged:
		return reflect.TypeOf(MedicinalProductPackaged{})
	case ResourceTypeMedicinalProductPharmaceutical:
		return reflect.TypeOf(MedicinalProductPharmaceutical{})
	case ResourceTypeMedicinalProductUndesirableEffect:
		return reflect.TypeOf(MedicinalProductUndesirableEffect{})
	case ResourceTypeMessageDefinition:
		return reflect.TypeOf(MessageDefinition{})
	case ResourceTypeMessageHeader:
		return reflect.TypeOf(MessageHeader{})
	case ResourceTypeMolecularSequence:
		return reflect.TypeOf(MolecularSequence{})
	case ResourceTypeNamingSystem:
		return reflect.TypeOf(NamingSystem{})
	case ResourceTypeNutritionOrder:
		return reflect.TypeOf(NutritionOrder{})
	case ResourceTypeObservation:
		return reflect.TypeOf(Observation{})
	case ResourceTypeObservationDefinition:
		return reflect.TypeOf(ObservationDefinition{})
	case ResourceTypeOperationDefinition:
		return reflect.TypeOf(OperationDefinition{})
	case ResourceTypeOperationOutcome:
		return reflect.TypeOf(OperationOutcome{})
	case ResourceTypeOrganization:
		return reflect.TypeOf(Organization{})
	case ResourceTypeOrganizationAffiliation:
		return reflect.TypeOf(OrganizationAffiliation{})
	case ResourceTypeParameters:
		return reflect.TypeOf(Parameters{})
	case ResourceTypePatient:
		return reflect.TypeOf(Patient{})
	case ResourceTypePaymentNotice:
		return reflect.TypeOf(PaymentNotice{})
	case ResourceTypePaymentReconciliation:
		return reflect.TypeOf(PaymentReconciliation{})
	case ResourceTypePerson:
		return reflect.TypeOf(Person{})
	case ResourceTypePlanDefinition:
		return reflect.TypeOf(PlanDefinition{})
	case ResourceTypePractitioner:
		return reflect.TypeOf(Practitioner{})
	case ResourceTypePractitionerRole:
		return reflect.TypeOf(PractitionerRole{})
	case ResourceTypeProcedure:
		return reflect.TypeOf(Procedure{})
	case ResourceTypeProvenance:
		return reflect.TypeOf(Provenance{})
	case ResourceTypeQuestionnaire:
		return reflect.TypeOf(Questionnaire{})
	case ResourceTypeQuestionnaireResponse:
		return reflect.TypeOf(QuestionnaireResponse{})
	case ResourceTypeRelatedPerson:
		return reflect.TypeOf(RelatedPerson{})
	case ResourceTypeRequestGroup:
		return reflect.TypeOf(RequestGroup{})
	case ResourceTypeResearchDefinition:
		return reflect.TypeOf(ResearchDefinition{})
	case ResourceTypeResearchElementDefinition:
		return reflect.TypeOf(ResearchElementDefinition{})
	case ResourceTypeResearchStudy:
		return reflect.TypeOf(ResearchStudy{})
	case ResourceTypeResearchSubject:
		return reflect.TypeOf(ResearchSubject{})
	case ResourceTypeResource:
		return reflect.TypeOf(Resource{})
	case ResourceTypeRiskAssessment:
		return reflect.TypeOf(RiskAssessment{})
	case ResourceTypeRiskEvidenceSynthesis:
		return reflect.TypeOf(RiskEvidenceSynthesis{})
	case ResourceTypeSchedule:
		return reflect.TypeOf(Schedule{})
	case ResourceTypeSearchParameter:
		return reflect.TypeOf(SearchParameter{})
	case ResourceTypeServiceRequest:
		return reflect.TypeOf(ServiceRequest{})
	case ResourceTypeSlot:
		return reflect.TypeOf(Slot{})
	case ResourceTypeSpecimen:
		return reflect.TypeOf(Specimen{})
	case ResourceTypeSpecimenDefinition:
		return reflect.TypeOf(SpecimenDefinition{})
	case ResourceTypeStructureDefinition:
		return reflect.TypeOf(StructureDefinition{})
	case ResourceTypeStructureMap:
		return reflect.TypeOf(StructureMap{})
	case ResourceTypeSubscription:
		return reflect.TypeOf(Subscription{})
	case ResourceTypeSubstance:
		return reflect.TypeOf(Substance{})
	case ResourceTypeSubstanceNucleicAcid:
		return reflect.TypeOf(SubstanceNucleicAcid{})
	case ResourceTypeSubstancePolymer:
		return reflect.TypeOf(SubstancePolymer{})
	case ResourceTypeSubstanceProtein:
		return reflect.TypeOf(SubstanceProtein{})
	case ResourceTypeSubstanceReferenceInformation:
		return reflect.TypeOf(SubstanceReferenceInformation{})
	case ResourceTypeSubstanceSourceMaterial:
		return reflect.TypeOf(SubstanceSourceMaterial{})
	case ResourceTypeSubstanceSpecification:
		return reflect.TypeOf(SubstanceSpecification{})
	case ResourceTypeSupplyDelivery:
		return reflect.TypeOf(SupplyDelivery{})
	case ResourceTypeSupplyRequest:
		return reflect.TypeOf(SupplyRequest{})
	case ResourceTypeTask:
		return reflect.TypeOf(Task{})
	case ResourceTypeTerminologyCapabilities:
		return reflect.TypeOf(TerminologyCapabilities{})
	case ResourceTypeTestReport:
		return reflect.TypeOf(TestReport{})
	case ResourceTypeTestScript:
		return reflect.TypeOf(TestScript{})
	case ResourceTypeValueSet:
		return reflect.TypeOf(ValueSet{})
	case ResourceTypeVerificationResult:
		return reflect.TypeOf(VerificationResult{})
	case ResourceTypeVisionPrescription:
		return reflect.TypeOf(VisionPrescription{})
	}
